...
from modules.osumapper.rhythm_loader import *;
from modules.osumapper.losses import GenerativeCustomLoss, BoxCustomLoss, AlwaysZeroCustomLoss;
from modules.osumapper.plot_tools import MyLine, plot_history;
