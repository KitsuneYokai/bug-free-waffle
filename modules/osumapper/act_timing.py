...
import numpy as np
import re, os
import modules.osumapper.include.id3reader_p3 as id3
from shutil import copy

from modules.osumapper.timing import *
from modules.osumapper.metadata import *

def get_timed_osu_file(music_path, input_filename = "modules/osumapper/assets/template.osu", output_filename = "timing.osu", game_mode = 0, mania_key_count = None):
